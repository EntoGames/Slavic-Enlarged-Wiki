...
- **Północ:** Połoczanie, ludy bałtyckie
- **Wschód:** Radymicze, Krywicze
- **Południe:** Drewlanie
- **Zachód:** ludy bałtyckie (Jaćwingowie), zachodniosłowiańskie
...
Dregowicze (od starosłowiańskiego "dregwa" — bagno) zamieszkiwali jedne z najtrudniejszych do zasiedlenia terenów Europy Wschodniej. Mimo to stworzyli sieć grodów wokół Turowa, który stał się stolicą osobnego księstwa. Stosunkowo wcześnie znaleźli się w orbicie wpływów Kijowa, ale zachowali odrębność kulturową.
...
### Mocne strony
- Osiem prowincji startowych to największe terytorium wśród wschodniosłowiańskich plemion w modzie
- Połączenie tradycji leśnej i rolniczej daje zarówno obronność, jak i stabilny dochód
- Bagienne tereny utrudniają wrogom inwazję

### Wyzwania
- Bagnisty teren oznacza niższy bazowy rozwój prowincji
- Brak tradycji militarnych lub miejskich ogranicza opcje ofensywne
- Otoczenie przez wiele kultur wymaga aktywnej dyplomacji
