...
- **Północ:** Obodrzyci, Wagriowie
- **Wschód:** Hawelanie (za Łabą)
- **Południe:** Serbowie Łużyccy, Sasi
- **Zachód:** Sasi (bezpośrednia granica)
...
Drzewanie, zwani też Połabianami właściwymi (od rzeki Łaby, po słowiańsku Poł-Łaby), byli najdalej na zachód wysuniętym plemieniem słowiańskim. Ich izolacja wśród lasów Wendlandu paradoksalnie zapewniła im najdłuższe przetrwanie kulturowe — język połabski, wywodzący się z ich dialektu, był używany do początku XVIII wieku, długo po germanizacji wszystkich pozostałych Połabian.
...
### Mocne strony
- Tradycje leśne i święte gaje tworzą doskonały profil obronny — wróg musi walczyć w twoich lasach
- Etos stoicki pomaga przetrwać kryzysy i utrzymać stabilność w obliczu silniejszych sąsiadów
- Trzy prowincje dają solidną bazę startową w porównaniu z innymi małymi Połabianami

### Wyzwania
- Najbardziej na zachód wysunięta pozycja oznacza bezpośredni kontakt z Sasami bez buforu
- Brak tradycji morskich lub ekonomicznych ogranicza źródła dochodów
- Izolacja od reszty Połabian utrudnia zawieranie sojuszy i wspólną obronę
