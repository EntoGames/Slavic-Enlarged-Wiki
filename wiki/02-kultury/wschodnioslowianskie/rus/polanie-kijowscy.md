...
- **Północ:** Drewlanie
- **Wschód:** Siewierzanie
- **Południe:** Ulicze, stepi koczownicze
- **Zachód:** Drewlanie, Wołynianie
...
Polanie kijowscy odegrali kluczową rolę w historii Europy Wschodniej jako plemię, wokół którego powstała Ruś Kijowska. Kijów, według legendy założony przez trzech braci — Kija, Szczeka i Chorywa — stał się stolicą jednego z najpotężniejszych państw średniowiecznej Europy. Polanie wyróżniali się wśród okolicznych plemion wyższym poziomem organizacji społecznej i rozwiniętymi kontaktami handlowymi.
...
### Mocne strony
- Tradycje miejska i dyplomatyczna tworzą potężną kombinację ekonomiczno-polityczną
- Etos dworski zwiększa prestiż, ułatwiając zdobywanie sojuszników
- Kontrola Kijowa — jednego z miejsc świętych — daje bonus religijny od startu

### Wyzwania
- Tylko dwie prowincje startowe oznaczają niewielką bazę terytorialną
- Brak tradycji militarnych wymaga polegania na dyplomacji i sojuszach
- Otwarte stepy na południu to stałe zagrożenie ze strony koczowników
