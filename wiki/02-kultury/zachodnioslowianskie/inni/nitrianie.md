...
- **Północ:** Morawianie, Polanie lechiccy
- **Wschód:** ludy madziarskie (nadchodzące zagrożenie!)
- **Południe:** Słowianie panońscy
- **Zachód:** Czesi, Morawianie
...
Księstwo Nitrzańskie było jednym z najstarszych słowiańskich organizmów państwowych, istniejącym od VII-VIII wieku. Książę Pribina, który rządził Nitrą przed włączeniem jej do Wielkich Moraw przez Mojmira I, wzniósł pierwszy znany kościół chrześcijański w regionie. W 867 roku Nitra funkcjonowała w ramach Wielkich Moraw, ale zachowywała odrębność — co odzwierciedla tradycja partykularyzmu w modzie.
...
### Mocne strony
- Biurokratyczny etos daje przewagę administracyjną — mniejsze koszty zarządzania i szybsze reformy
- Tradycja miejska i partykularyzm tworzą stabilne, dobrze bronione księstwo
- Strategiczne położenie między Czechami a Panonią otwiera wiele ścieżek dyplomatycznych

### Wyzwania
- Tylko jedna prowincja startowa — mała baza, wymagająca szybkiej ekspansji lub sojuszy
- Nadciągający najazd madzarski (Węgrzy) w późniejszych datach startowych stanowi egzystencjalne zagrożenie
- Rywalizacja z Morawianami o prymat w regionie czeskosłowackim
