...
/* ───── Pomerania: Baltic Shores — kingdom sub-mod ───── */
...
const frameStyle: React.CSSProperties = {
  ...
  backgroundImage: "url(/marketing/pomerania-kingdom-map.png)",
...
const KolovratGold: React.FC<{ size?: number }> = ({ size = 32 }) => (
  ...
  >
    <defs>
      <linearGradient id="kol-gold-sepm" x1="0" y1="0" x2="1" y2="1">
...
const Cover: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "center" }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Pomerania: Baltic Shores</CopyChip>
      <CopyChip kind="token">512 &times; 512 HTML</CopyChip>
    </div>

    <div style={frameStyle} role="img" aria-label="Okladka moda Pomerania: Baltic Shores -- Kingdom sub-mod dla Slavic Enlarged">
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", zIndex: 1, gap: 0, filter: "drop-shadow(0 2px 8px #1c2214) drop-shadow(0 6px 20px #1c2214)" }}>
        ...
        <p style={titleLargeStyle}>Pomerania</p>
        <p style={titleSmallStyle}>Baltic Shores</p>
      </div>
    ...
    <table style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "var(--fg-on-dark-soft)", borderCollapse: "collapse" }}>
      <tbody>
        ...
        <tr>
          ...
          <td style={{ padding: "4px 0", fontFamily: "var(--font-mono)", fontSize: 11 }}>sepm</td>
        </tr>
      </tbody>
    </table>
  </div>
...
const STEAM_EN = `[h1]Pomerania: Baltic Shores[/h1]
A [b]Slavic Enlarged[/b] kingdom sub-mod for Crusader Kings III.

A kingdom-level sub-mod expanding Pomerania with unique coastal cultures, maritime events, and decisions tied to the Baltic shores and the Wendish seafaring tradition.

[h1]Features[/h1]
[list]
[*] Tribal cultures of Pomerania
[*] Royal decision: forge the Pomeranian culture
[*] Unique maritime event chains
...
const STEAM_PL = `[h1]Pomerania: Baltic Shores[/h1]
Sub-mod krolewskiego poziomu dla [b]Slavic Enlarged[/b] do Crusader Kings III.

Sub-mod rozszerzajacy Pomorze o unikalne kultury przybrzezne, eventy morskie i decyzje zwiazane z wybrzezem baltyckim i wendecka tradycja zeglugi.

[h1]Zawartość[/h1]
[list]
[*] Kultury plemienne Pomorza
[*] Decyzja krolewska: stworzenie kultury Pomorskiej
[*] Unikalne eventy morskie
...
const Overview: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 640 }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Pomerania: Baltic Shores</CopyChip>
      <CopyChip kind="class">sepm</CopyChip>
    </div>
    <div style={{ fontFamily: "var(--font-body)", color: "var(--fg-on-dark)", lineHeight: 1.6 }}>
      <h2 style={{ fontFamily: "var(--font-display)", color: "var(--gold)", textShadow: "var(--shadow-carved)", margin: "0 0 12px" }}>
        Pomerania: Baltic Shores
      </h2>
      <p>Sub-mod krolewskiego poziomu rozszerzajacy Pomorze o unikalne kultury, eventy i decyzje zwiazane z wybrzezem baltyckim.</p>
      <ul style={{ paddingLeft: 20, marginTop: 12 }}>
        <li>Kultury plemienne Pomorza</li>
        <li>Decyzja krolewska: stworzenie kultury Pomorskiej</li>
        <li>Unikalne eventy morskie</li>
...
const Screenshots: Story = () => (
  <ScreenshotGallery
    modName="Pomerania: Baltic Shores"
    folder="sepm"
...
export default { title: "Marketing / Kingdoms / Pomerania Baltic Shores" };
