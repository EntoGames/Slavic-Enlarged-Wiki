...
/* ───── Novgorod: Northern Republic — kingdom sub-mod ───── */
...
const frameStyle: React.CSSProperties = {
  ...
  backgroundImage: "url(/marketing/novgorod-kingdom-map.png)",
...
const KolovratGold: React.FC<{ size?: number }> = ({ size = 32 }) => (
  ...
  >
    <defs>
      <linearGradient id="kol-gold-senv" x1="0" y1="0" x2="1" y2="1">
...
const Cover: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "center" }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Novgorod: Northern Republic</CopyChip>
      <CopyChip kind="token">512 &times; 512 HTML</CopyChip>
    </div>

    <div style={frameStyle} role="img" aria-label="Okladka moda Novgorod: Northern Republic -- Kingdom sub-mod dla Slavic Enlarged">
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", zIndex: 1, gap: 0, filter: "drop-shadow(0 2px 8px #1c2214) drop-shadow(0 6px 20px #1c2214)" }}>
        <p style={subtitleStyle}>Republic of</p>
        <p style={titleLargeStyle}>Novgorod</p>
        <p style={titleSmallStyle}>Northern Republic</p>
      </div>
    ...
    <table style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "var(--fg-on-dark-soft)", borderCollapse: "collapse" }}>
      <tbody>
        ...
        <tr>
          ...
          <td style={{ padding: "4px 0", fontFamily: "var(--font-mono)", fontSize: 11 }}>senv</td>
        </tr>
      </tbody>
    </table>
  </div>
...
const STEAM_EN = `[h1]Novgorod: Northern Republic[/h1]
A [b]Slavic Enlarged[/b] kingdom sub-mod for Crusader Kings III.

A kingdom-level sub-mod expanding the Novgorod region with unique cultures, merchant republic events, and decisions tied to the great northern trade networks.

[h1]Features[/h1]
[list]
[*] Tribal cultures of the Novgorod region
[*] Royal decision: forge the Novgorodian culture
[*] Unique merchant republic event chains
...
const STEAM_PL = `[h1]Novgorod: Northern Republic[/h1]
Sub-mod krolewskiego poziomu dla [b]Slavic Enlarged[/b] do Crusader Kings III.

Sub-mod rozszerzajacy region Nowogrodu o unikalne kultury, eventy republiki kupieckiej i decyzje zwiazane z wielkimi szlakami handlowymi polnocy.

[h1]Zawartość[/h1]
[list]
[*] Kultury plemienne regionu Nowogrodu
[*] Decyzja krolewska: stworzenie kultury Nowogrockiej
[*] Unikalne eventy republiki kupieckiej
...
const Overview: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 640 }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Novgorod: Northern Republic</CopyChip>
      <CopyChip kind="class">senv</CopyChip>
    </div>
    <div style={{ fontFamily: "var(--font-body)", color: "var(--fg-on-dark)", lineHeight: 1.6 }}>
      <h2 style={{ fontFamily: "var(--font-display)", color: "var(--gold)", textShadow: "var(--shadow-carved)", margin: "0 0 12px" }}>
        Novgorod: Northern Republic
      </h2>
      <p>Sub-mod krolewskiego poziomu rozszerzajacy Nowogrod o unikalne kultury, eventy i decyzje zwiazane z republika kupiecka polnocy.</p>
      <ul style={{ paddingLeft: 20, marginTop: 12 }}>
        <li>Kultury plemienne regionu Nowogrodu</li>
        <li>Decyzja krolewska: stworzenie kultury Nowogrockiej</li>
        <li>Unikalne eventy republiki kupieckiej</li>
...
const Screenshots: Story = () => (
  <ScreenshotGallery
    modName="Novgorod: Northern Republic"
    folder="senv"
...
export default { title: "Marketing / Kingdoms / Novgorod Northern Republic" };
