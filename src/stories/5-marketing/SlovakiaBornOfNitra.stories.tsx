...
/* ───── Slovakia: Born of Nitra — kingdom sub-mod ───── */
...
const frameStyle: React.CSSProperties = {
  ...
  backgroundImage: "url(/marketing/slovakia-kingdom-map.png)",
...
const KolovratGold: React.FC<{ size?: number }> = ({ size = 32 }) => (
  ...
  >
    <defs>
      <linearGradient id="kol-gold-sesk" x1="0" y1="0" x2="1" y2="1">
...
const Cover: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "center" }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Slovakia: Born of Nitra</CopyChip>
      <CopyChip kind="token">512 &times; 512 HTML</CopyChip>
    </div>

    <div style={frameStyle} role="img" aria-label="Okladka moda Slovakia: Born of Nitra -- Kingdom sub-mod dla Slavic Enlarged">
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", zIndex: 1, gap: 0, filter: "drop-shadow(0 2px 8px #1c2214) drop-shadow(0 6px 20px #1c2214)" }}>
        <p style={subtitleStyle}>Principality of</p>
        <p style={titleLargeStyle}>Slovakia</p>
        <p style={titleSmallStyle}>Born of Nitra</p>
      </div>
    ...
    <table style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "var(--fg-on-dark-soft)", borderCollapse: "collapse" }}>
      <tbody>
        ...
        <tr>
          ...
          <td style={{ padding: "4px 0", fontFamily: "var(--font-mono)", fontSize: 11 }}>sesk</td>
        </tr>
      </tbody>
    </table>
  </div>
...
const STEAM_EN = `[h1]Slovakia: Born of Nitra[/h1]
A [b]Slavic Enlarged[/b] kingdom sub-mod for Crusader Kings III.

A kingdom-level sub-mod expanding the Slovak region with unique cultures, events, and decisions tied to the Principality of Nitra, the Great Moravian legacy, and the mission of Saints Cyril and Methodius.

[h1]Features[/h1]
[list]
[*] Cultures of the Nitra and Great Moravian region
[*] Royal decision: restore the Principality of Nitra
[*] Unique Christianisation events (mission of Cyril and Methodius)
...
const STEAM_PL = `[h1]Slovakia: Born of Nitra[/h1]
Sub-mod krolewskiego poziomu dla [b]Slavic Enlarged[/b] do Crusader Kings III.

Sub-mod rozszerzajacy region Slowacji o unikalne kultury, eventy i decyzje zwiazane z Ksiestwem Nitrzanskim, dziedzictwem Wielkich Moraw oraz misja sw. Cyryla i Metodego.

[h1]Zawartość[/h1]
[list]
[*] Kultury regionu Nitry i Wielkich Moraw
[*] Decyzja krolewska: odrodzenie Ksiestwa Nitrzanskiego
[*] Unikalne eventy chrystianizacji (misja Cyryla i Metodego)
...
const Overview: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 640 }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Slovakia: Born of Nitra</CopyChip>
      <CopyChip kind="class">sesk</CopyChip>
    </div>
    <div style={{ fontFamily: "var(--font-body)", color: "var(--fg-on-dark)", lineHeight: 1.6 }}>
      <h2 style={{ fontFamily: "var(--font-display)", color: "var(--gold)", textShadow: "var(--shadow-carved)", margin: "0 0 12px" }}>
        Slovakia: Born of Nitra
      </h2>
      <p>Sub-mod krolewskiego poziomu rozszerzajacy region Slowacji o unikalne kultury, eventy i decyzje zwiazane z Ksiestwem Nitrzanskim i dziedzictwem Wielkich Moraw.</p>
      <ul style={{ paddingLeft: 20, marginTop: 12 }}>
        <li>Kultury regionu Nitry i Wielkich Moraw</li>
        <li>Decyzja krolewska: odrodzenie Ksiestwa Nitrzanskiego</li>
        <li>Unikalne eventy chrystianizacji (misja Cyryla i Metodego)</li>
...
const Screenshots: Story = () => (
  <ScreenshotGallery
    modName="Slovakia: Born of Nitra"
    folder="sesk"
...
export default { title: "Marketing / Kingdoms / Slovakia Born of Nitra" };
