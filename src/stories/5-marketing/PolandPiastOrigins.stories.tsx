...
/* ───── Poland: Piast Origins — kingdom sub-mod ───── */
...
const frameStyle: React.CSSProperties = {
  ...
  backgroundImage: "url(/marketing/poland-kingdom-map.png)",
...
const KolovratGold: React.FC<{ size?: number }> = ({ size = 32 }) => (
  ...
  >
    <defs>
      <linearGradient id="kol-gold-pl" x1="0" y1="0" x2="1" y2="1">
...
const Cover: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "center" }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Poland: Piast Origins</CopyChip>
      <CopyChip kind="token">512 &times; 512 HTML</CopyChip>
    </div>

    {/* === OKŁADKA === */}
    <div style={frameStyle} role="img" aria-label="Okładka moda Poland: Piast Origins — Kingdom sub-mod dla Slavic Enlarged">
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", zIndex: 1, gap: 0, filter: "drop-shadow(0 2px 8px #1c2214) drop-shadow(0 6px 20px #1c2214)" }}>
        ...
        <p style={titleLargeStyle}>Poland</p>
        <p style={titleSmallStyle}>Piast Origins</p>
      </div>

      {/* Badge */}
      <span style={badgeStyle}>Kingdom Sub-mod · Slavic Enlarged</span>
    </div>
    ...
    <table style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "var(--fg-on-dark-soft)", borderCollapse: "collapse" }}>
      <tbody>
        ...
        <tr>
          ...
          <td style={{ padding: "4px 0", fontFamily: "var(--font-mono)", fontSize: 11 }}>sepl_</td>
        </tr>
      </tbody>
    </table>
  </div>
...
const STEAM_EN = `[h1]Poland: Piast Origins[/h1]
A [b]Slavic Enlarged[/b] kingdom sub-mod for Crusader Kings III.

A kingdom-level sub-mod expanding Poland with unique tribal cultures, dynastic events, and decisions tied to the Piast dynasty and the formation of the Polish state.

[h1]Features[/h1]
[list]
[*] Tribal cultures: Polanie, Vistulans, Slezans, Mazovians, Goplans
[*] Royal decision: forge the Polish culture
[*] Unique Piast dynasty event chains
...
const STEAM_PL = `[h1]Poland: Piast Origins[/h1]
Sub-mod krolewskiego poziomu dla [b]Slavic Enlarged[/b] do Crusader Kings III.

Sub-mod rozszerzajacy Polske o unikalne kultury plemienne, eventy dynastyczne i decyzje zwiazane z dynastia Piastow i formowaniem sie panstwa polskiego.

[h1]Zawartosc[/h1]
[list]
[*] Kultury plemienne: Polanie, Wislanie, Slezanie, Mazowszanie, Goplanie
[*] Decyzja krolewska: stworzenie kultury Polskiej
[*] Unikalne eventy dynastii Piastow
...
const Overview: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 640 }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Poland: Piast Origins</CopyChip>
      <CopyChip kind="class">sepl_</CopyChip>
    </div>
    <div style={{ fontFamily: "var(--font-body)", color: "var(--fg-on-dark)", lineHeight: 1.6 }}>
      <h2 style={{ fontFamily: "var(--font-display)", color: "var(--gold)", textShadow: "var(--shadow-carved)", margin: "0 0 12px" }}>
        Poland: Piast Origins
      </h2>
      <p>
        Sub-mod krolewskiego poziomu rozszerzajacy Polske o unikalne kultury,
        eventy i decyzje zwiazane z dynastia Piastow i formowaniem sie
        panstwa polskiego.
      </p>
      <ul style={{ paddingLeft: 20, marginTop: 12 }}>
        <li>Kultury plemienne: Polanie, Wiślanie, Ślężanie, Mazowszanie, Goplanie</li>
        <li>Decyzja krolewska: stworzenie kultury Polskiej</li>
        <li>Unikalne eventy dynastii Piastów</li>
...
const PL_SCREENSHOTS: { src: string; alt: string }[] = [];

const Screenshots: Story = () => (
  <ScreenshotGallery
    modName="Poland: Piast Origins"
    folder="sepl"
...
export default { title: "Marketing / Kingdoms / Poland Piast Origins" };
