...
/* ───── Opolye: Eastern Steppe — kingdom sub-mod ───── */
...
const frameStyle: React.CSSProperties = {
  ...
  backgroundImage: "url(/marketing/opolye-kingdom-map.png)",
...
const KolovratGold: React.FC<{ size?: number }> = ({ size = 32 }) => (
  ...
  >
    <defs>
      <linearGradient id="kol-gold-seop" x1="0" y1="0" x2="1" y2="1">
...
const Cover: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "center" }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Opolye: Eastern Steppe</CopyChip>
      <CopyChip kind="token">512 &times; 512 HTML</CopyChip>
    </div>

    <div style={frameStyle} role="img" aria-label="Okladka moda Opolye: Eastern Steppe -- Kingdom sub-mod dla Slavic Enlarged">
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", zIndex: 1, gap: 0, filter: "drop-shadow(0 2px 8px #1c2214) drop-shadow(0 6px 20px #1c2214)" }}>
        ...
        <p style={titleLargeStyle}>Opolye</p>
        <p style={titleSmallStyle}>Eastern Steppe</p>
      </div>
    ...
    <table style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "var(--fg-on-dark-soft)", borderCollapse: "collapse" }}>
      <tbody>
        ...
        <tr>
          ...
          <td style={{ padding: "4px 0", fontFamily: "var(--font-mono)", fontSize: 11 }}>seop</td>
        </tr>
      </tbody>
    </table>
  </div>
...
const STEAM_EN = `[h1]Opolye: Eastern Steppe[/h1]
A [b]Slavic Enlarged[/b] kingdom sub-mod for Crusader Kings III.

A kingdom-level sub-mod expanding the Opolye region with unique cultures, events, and decisions tied to the eastern steppe frontier and its nomadic neighbours.

[h1]Features[/h1]
[list]
[*] Tribal cultures of Opolye
[*] Royal decision: forge the Opolyan culture
[*] Unique steppe frontier event chains
...
const STEAM_PL = `[h1]Opolye: Eastern Steppe[/h1]
Sub-mod krolewskiego poziomu dla [b]Slavic Enlarged[/b] do Crusader Kings III.

Sub-mod rozszerzajacy region Opola o unikalne kultury, eventy i decyzje zwiazane ze wschodnim pograniczem stepowym i koczowniczymi sasiadami.

[h1]Zawartość[/h1]
[list]
[*] Kultury plemienne Opola
[*] Decyzja krolewska: stworzenie kultury Opolskiej
[*] Unikalne eventy stepowe
...
const Overview: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 640 }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Opolye: Eastern Steppe</CopyChip>
      <CopyChip kind="class">seop</CopyChip>
    </div>
    <div style={{ fontFamily: "var(--font-body)", color: "var(--fg-on-dark)", lineHeight: 1.6 }}>
      <h2 style={{ fontFamily: "var(--font-display)", color: "var(--gold)", textShadow: "var(--shadow-carved)", margin: "0 0 12px" }}>
        Opolye: Eastern Steppe
      </h2>
      <p>Sub-mod krolewskiego poziomu rozszerzajacy Opolie o unikalne kultury, eventy i decyzje zwiazane ze wschodnimi stepami.</p>
      <ul style={{ paddingLeft: 20, marginTop: 12 }}>
        <li>Kultury plemienne Opola</li>
        <li>Decyzja krolewska: stworzenie kultury Opolskiej</li>
        <li>Unikalne eventy stepowe</li>
...
export default { title: "Marketing / Kingdoms / Opolye Eastern Steppe" };
