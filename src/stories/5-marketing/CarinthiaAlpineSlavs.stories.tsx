...
/* ───── Carinthia: Alpine Slavs — kingdom sub-mod ───── */
...
const frameStyle: React.CSSProperties = {
  ...
  backgroundImage: "url(/marketing/carinthia-kingdom-map.png)",
...
const KolovratGold: React.FC<{ size?: number }> = ({ size = 32 }) => (
  ...
  >
    <defs>
      <linearGradient id="kol-gold-seca" x1="0" y1="0" x2="1" y2="1">
...
const Cover: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "center" }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Carinthia: Alpine Slavs</CopyChip>
      <CopyChip kind="token">512 &times; 512 HTML</CopyChip>
    </div>

    <div style={frameStyle} role="img" aria-label="Okladka moda Carinthia: Alpine Slavs -- Kingdom sub-mod dla Slavic Enlarged">
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", zIndex: 1, gap: 0, filter: "drop-shadow(0 2px 8px #1c2214) drop-shadow(0 6px 20px #1c2214)" }}>
        ...
        <p style={titleLargeStyle}>Carinthia</p>
        <p style={titleSmallStyle}>Alpine Slavs</p>
      </div>
    ...
    <table style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "var(--fg-on-dark-soft)", borderCollapse: "collapse" }}>
      <tbody>
        ...
        <tr>
          ...
          <td style={{ padding: "4px 0", fontFamily: "var(--font-mono)", fontSize: 11 }}>seca</td>
        </tr>
      </tbody>
    </table>
  </div>
...
const STEAM_EN = `[h1]Carinthia: Alpine Slavs[/h1]
A [b]Slavic Enlarged[/b] kingdom sub-mod for Crusader Kings III.

A kingdom-level sub-mod expanding Carinthia with unique Alpine Slavic cultures, mountain events, and decisions tied to the Carantanian heritage in the southeastern Alps.

[h1]Features[/h1]
[list]
[*] Alpine Slavic cultures
[*] Royal decision: forge the Carinthian culture
[*] Unique mountain event chains
...
const STEAM_PL = `[h1]Carinthia: Alpine Slavs[/h1]
Sub-mod krolewskiego poziomu dla [b]Slavic Enlarged[/b] do Crusader Kings III.

Sub-mod rozszerzajacy Karyntie o unikalne kultury alpejskich Slowian, eventy gorskie i decyzje zwiazane z dziedzictwem Karantanii w poludniowo-wschodnich Alpach.

[h1]Zawartość[/h1]
[list]
[*] Kultury slowianskie regionu alpejskiego
[*] Decyzja krolewska: stworzenie kultury Karynckiej
[*] Unikalne eventy gorskie
...
const Overview: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 640 }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Carinthia: Alpine Slavs</CopyChip>
      <CopyChip kind="class">seca</CopyChip>
    </div>
    <div style={{ fontFamily: "var(--font-body)", color: "var(--fg-on-dark)", lineHeight: 1.6 }}>
      <h2 style={{ fontFamily: "var(--font-display)", color: "var(--gold)", textShadow: "var(--shadow-carved)", margin: "0 0 12px" }}>
        Carinthia: Alpine Slavs
      </h2>
      <p>Sub-mod krolewskiego poziomu rozszerzajacy Karyntie o unikalne kultury, eventy i decyzje zwiazane ze Slowianami alpejskimi.</p>
      <ul style={{ paddingLeft: 20, marginTop: 12 }}>
        <li>Kultury slowianskie regionu alpejskiego</li>
        <li>Decyzja krolewska: stworzenie kultury Karynckiej</li>
        <li>Unikalne eventy gorskie</li>
...
const Screenshots: Story = () => (
  <ScreenshotGallery
    modName="Carinthia: Alpine Slavs"
    folder="seca"
...
export default { title: "Marketing / Kingdoms / Carinthia Alpine Slavs" };
