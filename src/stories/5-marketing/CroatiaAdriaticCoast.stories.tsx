...
/* ───── Croatia: Adriatic Coast — kingdom sub-mod ───── */
...
const frameStyle: React.CSSProperties = {
  ...
  backgroundImage: "url(/marketing/croatia-kingdom-map.png)",
...
const KolovratGold: React.FC<{ size?: number }> = ({ size = 32 }) => (
  ...
  >
    <defs>
      <linearGradient id="kol-gold-secr" x1="0" y1="0" x2="1" y2="1">
...
const Cover: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "center" }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Croatia: Adriatic Coast</CopyChip>
      <CopyChip kind="token">512 &times; 512 HTML</CopyChip>
    </div>

    <div style={frameStyle} role="img" aria-label="Okladka moda Croatia: Adriatic Coast -- Kingdom sub-mod dla Slavic Enlarged">
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", zIndex: 1, gap: 0, filter: "drop-shadow(0 2px 8px #1c2214) drop-shadow(0 6px 20px #1c2214)" }}>
        ...
        <p style={titleLargeStyle}>Croatia</p>
        <p style={titleSmallStyle}>Adriatic Coast</p>
      </div>
    ...
    <table style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "var(--fg-on-dark-soft)", borderCollapse: "collapse" }}>
      <tbody>
        ...
        <tr>
          ...
          <td style={{ padding: "4px 0", fontFamily: "var(--font-mono)", fontSize: 11 }}>secr</td>
        </tr>
      </tbody>
    </table>
  </div>
...
const STEAM_EN = `[h1]Croatia: Adriatic Coast[/h1]
A [b]Slavic Enlarged[/b] kingdom sub-mod for Crusader Kings III.

A kingdom-level sub-mod expanding Croatia with unique Adriatic cultures, maritime and trade events, and decisions tied to the Croatian kingdom between Venice and Byzantium.

[h1]Features[/h1]
[list]
[*] Tribal cultures of Croatia
[*] Royal decision: forge the Croatian culture
[*] Unique maritime and trade event chains
...
const STEAM_PL = `[h1]Croatia: Adriatic Coast[/h1]
Sub-mod krolewskiego poziomu dla [b]Slavic Enlarged[/b] do Crusader Kings III.

Sub-mod rozszerzajacy Chorwacje o unikalne kultury adriatyckie, eventy morskie i handlowe oraz decyzje zwiazane z krolestwem chorwackim miedzy Wenecja a Bizancjum.

[h1]Zawartość[/h1]
[list]
[*] Kultury plemienne Chorwacji
[*] Decyzja krolewska: stworzenie kultury Chorwackiej
[*] Unikalne eventy morskie i handlowe
...
const Overview: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 640 }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Croatia: Adriatic Coast</CopyChip>
      <CopyChip kind="class">secr</CopyChip>
    </div>
    <div style={{ fontFamily: "var(--font-body)", color: "var(--fg-on-dark)", lineHeight: 1.6 }}>
      ...
      <p>Sub-mod krolewskiego poziomu rozszerzajacy Chorwacje o unikalne kultury, eventy i decyzje zwiazane z wybrzezem adriatyckim.</p>
      <ul style={{ paddingLeft: 20, marginTop: 12 }}>
        <li>Kultury plemienne Chorwacji</li>
        <li>Decyzja krolewska: stworzenie kultury Chorwackiej</li>
        <li>Unikalne eventy morskie i handlowe</li>
...
const Screenshots: Story = () => (
  <ScreenshotGallery
    modName="Croatia: Adriatic Coast"
    folder="secr"
...
export default { title: "Marketing / Kingdoms / Croatia Adriatic Coast" };
