...
/* ───── Ruthenia: Ancient Heartland — kingdom sub-mod ───── */
...
const frameStyle: React.CSSProperties = {
  ...
  backgroundImage: "url(/marketing/ruthenia-kingdom-map.png)",
...
const KolovratGold: React.FC<{ size?: number }> = ({ size = 32 }) => (
  ...
  >
    <defs>
      <linearGradient id="kol-gold-sekr" x1="0" y1="0" x2="1" y2="1">
...
const Cover: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "center" }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Ruthenia: Ancient Heartland</CopyChip>
      <CopyChip kind="token">512 &times; 512 HTML</CopyChip>
    </div>

    <div style={frameStyle} role="img" aria-label="Okladka moda Ruthenia: Ancient Heartland -- Kingdom sub-mod dla Slavic Enlarged">
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", zIndex: 1, gap: 0, filter: "drop-shadow(0 2px 8px #1c2214) drop-shadow(0 6px 20px #1c2214)" }}>
        ...
        <p style={titleLargeStyle}>Ruthenia</p>
        <p style={titleSmallStyle}>Ancient Heartland</p>
      </div>
    ...
    <table style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "var(--fg-on-dark-soft)", borderCollapse: "collapse" }}>
      <tbody>
        ...
        <tr>
          ...
          <td style={{ padding: "4px 0", fontFamily: "var(--font-mono)", fontSize: 11 }}>sekr</td>
        </tr>
      </tbody>
    </table>
  </div>
...
const STEAM_EN = `[h1]Ruthenia: Ancient Heartland[/h1]
A [b]Slavic Enlarged[/b] kingdom sub-mod for Crusader Kings III.

A kingdom-level sub-mod expanding the Kievan Rus region with unique tribal cultures, dynastic events, and decisions tied to the formation of the Ruthenian state.

[h1]Features[/h1]
[list]
[*] Tribal cultures of the Rus heartland
[*] Royal decision: forge the Ruthenian culture
[*] Unique dynastic event chains
...
const STEAM_PL = `[h1]Ruthenia: Ancient Heartland[/h1]
Sub-mod krolewskiego poziomu dla [b]Slavic Enlarged[/b] do Crusader Kings III.

Sub-mod rozszerzajacy region Rusi Kijowskiej o unikalne kultury plemienne, eventy dynastyczne i decyzje zwiazane z formowaniem sie panstwa ruskiego.

[h1]Zawartość[/h1]
[list]
[*] Kultury plemienne regionu Rusi
[*] Decyzja krolewska: stworzenie kultury Ruskiej
[*] Unikalne eventy dynastyczne
...
const Overview: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 640 }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Ruthenia: Ancient Heartland</CopyChip>
      <CopyChip kind="class">sekr</CopyChip>
    </div>
    <div style={{ fontFamily: "var(--font-body)", color: "var(--fg-on-dark)", lineHeight: 1.6 }}>
      <h2 style={{ fontFamily: "var(--font-display)", color: "var(--gold)", textShadow: "var(--shadow-carved)", margin: "0 0 12px" }}>
        Ruthenia: Ancient Heartland
      </h2>
      <p>Sub-mod krolewskiego poziomu rozszerzajacy Rus Kijowska o unikalne kultury, eventy i decyzje zwiazane z formowaniem sie panstwa ruskiego.</p>
      <ul style={{ paddingLeft: 20, marginTop: 12 }}>
        <li>Kultury plemienne regionu Rusi</li>
        <li>Decyzja krolewska: stworzenie kultury Ruskiej</li>
        <li>Unikalne eventy dynastyczne</li>
...
const Screenshots: Story = () => (
  <ScreenshotGallery
    modName="Ruthenia: Ancient Heartland"
    folder="sekr"
...
export default { title: "Marketing / Kingdoms / Ruthenia Ancient Heartland" };
