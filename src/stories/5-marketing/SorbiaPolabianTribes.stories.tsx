...
/* ───── Sorbia: Polabian Tribes — kingdom sub-mod ───── */
...
const frameStyle: React.CSSProperties = {
  ...
  backgroundImage: "url(/marketing/sorbia-kingdom-map.png)",
...
const KolovratGold: React.FC<{ size?: number }> = ({ size = 32 }) => (
  ...
  >
    <defs>
      <linearGradient id="kol-gold-sesb" x1="0" y1="0" x2="1" y2="1">
...
const Cover: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "center" }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Sorbia: Polabian Tribes</CopyChip>
      <CopyChip kind="token">512 &times; 512 HTML</CopyChip>
    </div>

    <div style={frameStyle} role="img" aria-label="Okladka moda Sorbia: Polabian Tribes -- Kingdom sub-mod dla Slavic Enlarged">
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", zIndex: 1, gap: 0, filter: "drop-shadow(0 2px 8px #1c2214) drop-shadow(0 6px 20px #1c2214)" }}>
        ...
        <p style={titleLargeStyle}>Sorbia</p>
        <p style={titleSmallStyle}>Polabian Tribes</p>
      </div>
    ...
    <table style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "var(--fg-on-dark-soft)", borderCollapse: "collapse" }}>
      <tbody>
        ...
        <tr>
          ...
          <td style={{ padding: "4px 0", fontFamily: "var(--font-mono)", fontSize: 11 }}>sesb</td>
        </tr>
      </tbody>
    </table>
  </div>
...
const STEAM_EN = `[h1]Sorbia: Polabian Tribes[/h1]
A [b]Slavic Enlarged[/b] kingdom sub-mod for Crusader Kings III.

A kingdom-level sub-mod expanding Sorbia with unique Polabian Slavic cultures, events, and decisions tied to the struggle against the Holy Roman Empire and Germanisation.

[h1]Features[/h1]
[list]
[*] Polabian Slavic tribal cultures
[*] Royal decision: forge the Sorbian culture
[*] Unique events: conflict with the Holy Roman Empire
...
const STEAM_PL = `[h1]Sorbia: Polabian Tribes[/h1]
Sub-mod krolewskiego poziomu dla [b]Slavic Enlarged[/b] do Crusader Kings III.

Sub-mod rozszerzajacy Serbie Luzycka o unikalne kultury slowianskie Polabian, eventy i decyzje zwiazane z walka przeciw Swiętemu Cesarstwu i germanizacji.

[h1]Zawartość[/h1]
[list]
[*] Kultury plemienne Polabian
[*] Decyzja krolewska: stworzenie kultury Luzycko-Serbskiej
[*] Unikalne eventy konfliktu ze Swietym Cesarstwem
...
const Overview: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 640 }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Sorbia: Polabian Tribes</CopyChip>
      <CopyChip kind="class">sesb</CopyChip>
    </div>
    <div style={{ fontFamily: "var(--font-body)", color: "var(--fg-on-dark)", lineHeight: 1.6 }}>
      <h2 style={{ fontFamily: "var(--font-display)", color: "var(--gold)", textShadow: "var(--shadow-carved)", margin: "0 0 12px" }}>
        Sorbia: Polabian Tribes
      </h2>
      <p>Sub-mod krolewskiego poziomu rozszerzajacy Serbie Luzycka o unikalne kultury, eventy i decyzje zwiazane z plemionami polabskimi.</p>
      <ul style={{ paddingLeft: 20, marginTop: 12 }}>
        <li>Kultury plemienne Polabian</li>
        <li>Decyzja krolewska: stworzenie kultury Luzycko-Serbskiej</li>
        <li>Unikalne eventy konfliktu ze Swietym Cesarstwem</li>
...
const Screenshots: Story = () => (
  <ScreenshotGallery
    modName="Sorbia: Polabian Tribes"
    folder="sesb"
...
export default { title: "Marketing / Kingdoms / Sorbia Polabian Tribes" };
