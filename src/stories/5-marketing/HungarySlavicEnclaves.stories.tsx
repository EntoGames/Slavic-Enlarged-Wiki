...
/* ───── Hungary: Slavic Enclaves — kingdom sub-mod ───── */
...
const frameStyle: React.CSSProperties = {
  ...
  backgroundImage: "url(/marketing/hungary-kingdom-map.png)",
...
const KolovratGold: React.FC<{ size?: number }> = ({ size = 32 }) => (
  ...
  >
    <defs>
      <linearGradient id="kol-gold-sehg" x1="0" y1="0" x2="1" y2="1">
...
const Cover: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "center" }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Hungary: Slavic Enclaves</CopyChip>
      <CopyChip kind="token">512 &times; 512 HTML</CopyChip>
    </div>

    <div style={frameStyle} role="img" aria-label="Okladka moda Hungary: Slavic Enclaves -- Kingdom sub-mod dla Slavic Enlarged">
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", zIndex: 1, gap: 0, filter: "drop-shadow(0 2px 8px #1c2214) drop-shadow(0 6px 20px #1c2214)" }}>
        ...
        <p style={titleLargeStyle}>Hungary</p>
        <p style={titleSmallStyle}>Slavic Enclaves</p>
      </div>
    ...
    <table style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "var(--fg-on-dark-soft)", borderCollapse: "collapse" }}>
      <tbody>
        ...
        <tr>
          ...
          <td style={{ padding: "4px 0", fontFamily: "var(--font-mono)", fontSize: 11 }}>sehg</td>
        </tr>
      </tbody>
    </table>
  </div>
...
const STEAM_EN = `[h1]Hungary: Slavic Enclaves[/h1]
A [b]Slavic Enlarged[/b] kingdom sub-mod for Crusader Kings III.

A kingdom-level sub-mod expanding Hungary with unique Slavic enclave cultures, events, and decisions tied to the coexistence of Slavic and Magyar peoples in the Pannonian basin.

[h1]Features[/h1]
[list]
[*] Slavic cultures within the Hungarian realm
[*] Royal decision: forge the Slavic-Hungarian culture
[*] Unique cultural coexistence event chains
...
const STEAM_PL = `[h1]Hungary: Slavic Enclaves[/h1]
Sub-mod krolewskiego poziomu dla [b]Slavic Enlarged[/b] do Crusader Kings III.

Sub-mod rozszerzajacy Wegry o unikalne kultury slowianskich enklaw, eventy i decyzje zwiazane ze wspolistnieniem Slowian i Madziarow w kotlinie pannonskiej.

[h1]Zawartość[/h1]
[list]
[*] Kultury slowianskie na terenie Wegier
[*] Decyzja krolewska: stworzenie kultury Slowacko-Wegierskiej
[*] Unikalne eventy koegzystencji kulturowej
...
const Overview: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 640 }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Hungary: Slavic Enclaves</CopyChip>
      <CopyChip kind="class">sehg</CopyChip>
    </div>
    <div style={{ fontFamily: "var(--font-body)", color: "var(--fg-on-dark)", lineHeight: 1.6 }}>
      <h2 style={{ fontFamily: "var(--font-display)", color: "var(--gold)", textShadow: "var(--shadow-carved)", margin: "0 0 12px" }}>
        Hungary: Slavic Enclaves
      </h2>
      <p>Sub-mod krolewskiego poziomu rozszerzajacy Wegry o unikalne kultury slowianskie, eventy i decyzje zwiazane z enklawami slowianskimi.</p>
      <ul style={{ paddingLeft: 20, marginTop: 12 }}>
        <li>Kultury slowianskie na terenie Wegier</li>
        <li>Decyzja krolewska: stworzenie kultury Slowacko-Wegierskiej</li>
        <li>Unikalne eventy koegzystencji kulturowej</li>
...
const Screenshots: Story = () => (
  <ScreenshotGallery
    modName="Hungary: Slavic Enclaves"
    folder="sehg"
...
export default { title: "Marketing / Kingdoms / Hungary Slavic Enclaves" };
