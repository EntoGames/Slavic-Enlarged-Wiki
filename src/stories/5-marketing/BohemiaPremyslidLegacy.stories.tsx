...
/* ───── Bohemia: Přemyslid Legacy — kingdom sub-mod ───── */
...
const frameStyle: React.CSSProperties = {
  ...
  backgroundImage: "url(/marketing/bohemia-kingdom-map.png)",
...
const KolovratGold: React.FC<{ size?: number }> = ({ size = 32 }) => (
  ...
  >
    <defs>
      <linearGradient id="kol-gold-sebh" x1="0" y1="0" x2="1" y2="1">
...
const Cover: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "center" }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Bohemia: Přemyslid Legacy</CopyChip>
      <CopyChip kind="token">512 &times; 512 HTML</CopyChip>
    </div>

    <div style={frameStyle} role="img" aria-label="Okladka moda Bohemia: Přemyslid Legacy -- Kingdom sub-mod dla Slavic Enlarged">
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", zIndex: 1, gap: 0, filter: "drop-shadow(0 2px 8px #1c2214) drop-shadow(0 6px 20px #1c2214)" }}>
        ...
        <p style={titleLargeStyle}>Bohemia</p>
        <p style={titleSmallStyle}>Přemyslid Legacy</p>
      </div>
    ...
    <table style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "var(--fg-on-dark-soft)", borderCollapse: "collapse" }}>
      <tbody>
        ...
        <tr>
          ...
          <td style={{ padding: "4px 0", fontFamily: "var(--font-mono)", fontSize: 11 }}>sebh</td>
        </tr>
      </tbody>
    </table>
  </div>
...
const STEAM_EN = `[h1]Bohemia: Přemyslid Legacy[/h1]
A [b]Slavic Enlarged[/b] kingdom sub-mod for Crusader Kings III.

A kingdom-level sub-mod expanding Bohemia with unique cultures, events, and decisions tied to the Přemyslid dynasty, the Christianisation of the Czechs, and the balance between independence and Imperial vassalage.

[h1]Features[/h1]
[list]
[*] Czech and Moravian cultures
[*] Royal decision: restore the Přemyslid legacy
[*] Unique Christianisation events (St. Wenceslas, Bořivoj)
...
const STEAM_PL = `[h1]Bohemia: Přemyslid Legacy[/h1]
Sub-mod krolewskiego poziomu dla [b]Slavic Enlarged[/b] do Crusader Kings III.

Sub-mod rozszerzajacy Czechy o unikalne kultury, eventy i decyzje zwiazane z dynastia Przemyslidow, chrystianizacja Czech oraz balansem miedzy niezaleznoscia a wasalstwem cesarskim.

[h1]Zawartość[/h1]
[list]
[*] Kultury czeskie i morawskie
[*] Decyzja krolewska: odnowienie dziedzictwa Przemyslidow
[*] Unikalne eventy chrystianizacji (sw. Waclaw, Boriwoj)
...
const Overview: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 640 }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Bohemia: Přemyslid Legacy</CopyChip>
      <CopyChip kind="class">sebh</CopyChip>
    </div>
    <div style={{ fontFamily: "var(--font-body)", color: "var(--fg-on-dark)", lineHeight: 1.6 }}>
      <h2 style={{ fontFamily: "var(--font-display)", color: "var(--gold)", textShadow: "var(--shadow-carved)", margin: "0 0 12px" }}>
        Bohemia: Přemyslid Legacy
      </h2>
      <p>Sub-mod krolewskiego poziomu rozszerzajacy Czechy o unikalne kultury, eventy i decyzje zwiazane z dynastia Przemyslidow, chrystianizacja i rywalizacja z Cesarstwem.</p>
      <ul style={{ paddingLeft: 20, marginTop: 12 }}>
        <li>Kultury czeskie i morawskie</li>
        <li>Decyzja krolewska: odnowienie dziedzictwa Przemyslidow</li>
        <li>Unikalne eventy chrystianizacji (sw. Waclaw, Boriwoj)</li>
...
const Screenshots: Story = () => (
  <ScreenshotGallery
    modName="Bohemia: Přemyslid Legacy"
    folder="sebh"
...
export default { title: "Marketing / Kingdoms / Bohemia Premyslid Legacy" };
