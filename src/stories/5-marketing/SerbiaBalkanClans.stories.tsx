...
/* ───── Serbia: Balkan Clans — kingdom sub-mod ───── */
...
const frameStyle: React.CSSProperties = {
  ...
  backgroundImage: "url(/marketing/serbia-kingdom-map.png)",
...
const KolovratGold: React.FC<{ size?: number }> = ({ size = 32 }) => (
  ...
  >
    <defs>
      <linearGradient id="kol-gold-serb" x1="0" y1="0" x2="1" y2="1">
...
const Cover: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "center" }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Serbia: Balkan Clans</CopyChip>
      <CopyChip kind="token">512 &times; 512 HTML</CopyChip>
    </div>

    <div style={frameStyle} role="img" aria-label="Okladka moda Serbia: Balkan Clans -- Kingdom sub-mod dla Slavic Enlarged">
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", zIndex: 1, gap: 0, filter: "drop-shadow(0 2px 8px #1c2214) drop-shadow(0 6px 20px #1c2214)" }}>
        ...
        <p style={titleLargeStyle}>Serbia</p>
        <p style={titleSmallStyle}>Balkan Clans</p>
      </div>
    ...
    <table style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "var(--fg-on-dark-soft)", borderCollapse: "collapse" }}>
      <tbody>
        ...
        <tr>
          ...
          <td style={{ padding: "4px 0", fontFamily: "var(--font-mono)", fontSize: 11 }}>serb</td>
        </tr>
      </tbody>
    </table>
  </div>
...
const STEAM_EN = `[h1]Serbia: Balkan Clans[/h1]
A [b]Slavic Enlarged[/b] kingdom sub-mod for Crusader Kings III.

A kingdom-level sub-mod expanding Serbia with unique Balkan clan cultures, events, and decisions tied to the Serbian zhupanates and their struggle for unification.

[h1]Features[/h1]
[list]
[*] Tribal cultures of Serbia
[*] Royal decision: forge the Serbian culture
[*] Unique clan event chains
...
const STEAM_PL = `[h1]Serbia: Balkan Clans[/h1]
Sub-mod krolewskiego poziomu dla [b]Slavic Enlarged[/b] do Crusader Kings III.

Sub-mod rozszerzajacy Serbie o unikalne kultury klanow balkanskich, eventy i decyzje zwiazane z serbskimi zupanami i ich walka o zjednoczenie.

[h1]Zawartość[/h1]
[list]
[*] Kultury plemienne Serbii
[*] Decyzja krolewska: stworzenie kultury Serbskiej
[*] Unikalne eventy klanowe
...
const Overview: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 640 }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Serbia: Balkan Clans</CopyChip>
      <CopyChip kind="class">serb</CopyChip>
    </div>
    <div style={{ fontFamily: "var(--font-body)", color: "var(--fg-on-dark)", lineHeight: 1.6 }}>
      ...
      <p>Sub-mod krolewskiego poziomu rozszerzajacy Serbie o unikalne kultury, eventy i decyzje zwiazane z klanami balkanskimi.</p>
      <ul style={{ paddingLeft: 20, marginTop: 12 }}>
        <li>Kultury plemienne Serbii</li>
        <li>Decyzja krolewska: stworzenie kultury Serbskiej</li>
        <li>Unikalne eventy klanowe</li>
...
export default { title: "Marketing / Kingdoms / Serbia Balkan Clans" };
