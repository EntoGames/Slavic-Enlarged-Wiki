...
/* ───── White Ruthenia: Forest Tribes — kingdom sub-mod ───── */
...
const frameStyle: React.CSSProperties = {
  ...
  backgroundImage: "url(/marketing/white_ruthenia-kingdom-map.png)",
...
const KolovratGold: React.FC<{ size?: number }> = ({ size = 32 }) => (
  ...
  >
    <defs>
      <linearGradient id="kol-gold-sewr" x1="0" y1="0" x2="1" y2="1">
...
const Cover: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "center" }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">White Ruthenia: Forest Tribes</CopyChip>
      <CopyChip kind="token">512 &times; 512 HTML</CopyChip>
    </div>

    <div style={frameStyle} role="img" aria-label="Okladka moda White Ruthenia: Forest Tribes -- Kingdom sub-mod dla Slavic Enlarged">
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", zIndex: 1, gap: 0, filter: "drop-shadow(0 2px 8px #1c2214) drop-shadow(0 6px 20px #1c2214)" }}>
        ...
        <p style={titleLargeStyle}>White Ruthenia</p>
        <p style={titleSmallStyle}>Forest Tribes</p>
      </div>
    ...
    <table style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "var(--fg-on-dark-soft)", borderCollapse: "collapse" }}>
      <tbody>
        ...
        <tr>
          ...
          <td style={{ padding: "4px 0", fontFamily: "var(--font-mono)", fontSize: 11 }}>sewr</td>
        </tr>
      </tbody>
    </table>
  </div>
...
const STEAM_EN = `[h1]White Ruthenia: Forest Tribes[/h1]
A [b]Slavic Enlarged[/b] kingdom sub-mod for Crusader Kings III.

A kingdom-level sub-mod expanding White Ruthenia with unique forest tribe cultures, events, and decisions tied to the primeval wilderness of the northern marshlands.

[h1]Features[/h1]
[list]
[*] Tribal cultures of White Ruthenia
[*] Royal decision: forge the White Ruthenian culture
[*] Unique events tied to the ancient forests
...
const STEAM_PL = `[h1]White Ruthenia: Forest Tribes[/h1]
Sub-mod krolewskiego poziomu dla [b]Slavic Enlarged[/b] do Crusader Kings III.

Sub-mod rozszerzajacy Bialorus o unikalne kultury lesnych plemion, eventy i decyzje zwiazane z pradawnymi puszczami polnocnych mokradel.

[h1]Zawartość[/h1]
[list]
[*] Kultury plemienne Bialej Rusi
[*] Decyzja krolewska: stworzenie kultury Bialoruskiej
[*] Unikalne eventy zwiazane z pradawnymi puszczami
...
const Overview: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 640 }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">White Ruthenia: Forest Tribes</CopyChip>
      <CopyChip kind="class">sewr</CopyChip>
    </div>
    <div style={{ fontFamily: "var(--font-body)", color: "var(--fg-on-dark)", lineHeight: 1.6 }}>
      <h2 style={{ fontFamily: "var(--font-display)", color: "var(--gold)", textShadow: "var(--shadow-carved)", margin: "0 0 12px" }}>
        White Ruthenia: Forest Tribes
      </h2>
      <p>Sub-mod krolewskiego poziomu rozszerzajacy Bialorus o unikalne kultury, eventy i decyzje zwiazane z plemionami lesnych puszcz.</p>
      <ul style={{ paddingLeft: 20, marginTop: 12 }}>
        <li>Kultury plemienne Bialej Rusi</li>
        <li>Decyzja krolewska: stworzenie kultury Bialoruskiej</li>
        <li>Unikalne eventy zwiazane z puszczami</li>
...
const Screenshots: Story = () => (
  <ScreenshotGallery
    modName="White Ruthenia: Forest Tribes"
    folder="sewr"
...
export default { title: "Marketing / Kingdoms / White Ruthenia Forest Tribes" };
