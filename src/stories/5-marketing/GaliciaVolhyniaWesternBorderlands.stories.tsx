...
/* ───── Galicia-Volhynia: Western Borderlands — kingdom sub-mod ───── */
...
const frameStyle: React.CSSProperties = {
  ...
  backgroundImage: "url(/marketing/galicia_volhynia-kingdom-map.png)",
...
const KolovratGold: React.FC<{ size?: number }> = ({ size = 32 }) => (
  ...
  >
    <defs>
      <linearGradient id="kol-gold-segv" x1="0" y1="0" x2="1" y2="1">
...
const Cover: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "center" }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Galicia-Volhynia: Western Borderlands</CopyChip>
      <CopyChip kind="token">512 &times; 512 HTML</CopyChip>
    </div>

    <div style={frameStyle} role="img" aria-label="Okladka moda Galicia-Volhynia: Western Borderlands -- Kingdom sub-mod dla Slavic Enlarged">
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", zIndex: 1, gap: 0, filter: "drop-shadow(0 2px 8px #1c2214) drop-shadow(0 6px 20px #1c2214)" }}>
        <p style={subtitleStyle}>Kingdom of</p>
        <p style={titleLargeStyle}>Galicia-Volhynia</p>
        <p style={titleSmallStyle}>Western Borderlands</p>
      </div>
    ...
    <table style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "var(--fg-on-dark-soft)", borderCollapse: "collapse" }}>
      <tbody>
        ...
        <tr>
          ...
          <td style={{ padding: "4px 0", fontFamily: "var(--font-mono)", fontSize: 11 }}>segv</td>
        </tr>
      </tbody>
    </table>
  </div>
...
const STEAM_EN = `[h1]Galicia-Volhynia: Western Borderlands[/h1]
A [b]Slavic Enlarged[/b] kingdom sub-mod for Crusader Kings III.

A kingdom-level sub-mod expanding the Galicia-Volhynia region with unique borderland cultures, events, and decisions tied to the western frontier between Slavic and Latin worlds.

[h1]Features[/h1]
[list]
[*] Tribal cultures of Galicia and Volhynia
[*] Royal decision: forge the Galician-Volhynian culture
[*] Unique borderland event chains
...
const STEAM_PL = `[h1]Galicia-Volhynia: Western Borderlands[/h1]
Sub-mod krolewskiego poziomu dla [b]Slavic Enlarged[/b] do Crusader Kings III.

Sub-mod rozszerzajacy region Halicko-Wolynski o unikalne kultury pogranicza, eventy i decyzje zwiazane z zachodnia granica miedzy swiatem slowianskim a lacinskim.

[h1]Zawartość[/h1]
[list]
[*] Kultury plemienne Halicza i Wolynia
[*] Decyzja krolewska: stworzenie kultury Halicko-Wolynskiej
[*] Unikalne eventy pogranicza
...
const Overview: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 640 }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Galicia-Volhynia: Western Borderlands</CopyChip>
      <CopyChip kind="class">segv</CopyChip>
    </div>
    <div style={{ fontFamily: "var(--font-body)", color: "var(--fg-on-dark)", lineHeight: 1.6 }}>
      <h2 style={{ fontFamily: "var(--font-display)", color: "var(--gold)", textShadow: "var(--shadow-carved)", margin: "0 0 12px" }}>
        Galicia-Volhynia: Western Borderlands
      </h2>
      <p>Sub-mod krolewskiego poziomu rozszerzajacy Halicz-Wolynskie o unikalne kultury, eventy i decyzje zwiazane z pograniczem zachodnim.</p>
      <ul style={{ paddingLeft: 20, marginTop: 12 }}>
        <li>Kultury plemienne Halicza i Wolynia</li>
        <li>Decyzja krolewska: stworzenie kultury Halicko-Wolynskiej</li>
        <li>Unikalne eventy pogranicza</li>
...
const Screenshots: Story = () => (
  <ScreenshotGallery
    modName="Galicia-Volhynia: Western Borderlands"
    folder="segv"
...
export default { title: "Marketing / Kingdoms / Galicia-Volhynia Western Borderlands" };
