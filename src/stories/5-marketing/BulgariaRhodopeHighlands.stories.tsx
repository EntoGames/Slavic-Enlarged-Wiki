...
/* ───── Bulgaria: Rhodope Highlands — kingdom sub-mod ───── */
...
const frameStyle: React.CSSProperties = {
  ...
  backgroundImage: "url(/marketing/bulgaria-kingdom-map.png)",
...
const KolovratGold: React.FC<{ size?: number }> = ({ size = 32 }) => (
  ...
  >
    <defs>
      <linearGradient id="kol-gold-sebg" x1="0" y1="0" x2="1" y2="1">
...
const Cover: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "center" }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Bulgaria: Rhodope Highlands</CopyChip>
      <CopyChip kind="token">512 &times; 512 HTML</CopyChip>
    </div>

    <div style={frameStyle} role="img" aria-label="Okladka moda Bulgaria: Rhodope Highlands -- Kingdom sub-mod dla Slavic Enlarged">
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", zIndex: 1, gap: 0, filter: "drop-shadow(0 2px 8px #1c2214) drop-shadow(0 6px 20px #1c2214)" }}>
        ...
        <p style={titleLargeStyle}>Bulgaria</p>
        <p style={titleSmallStyle}>Rhodope Highlands</p>
      </div>
    ...
    <table style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "var(--fg-on-dark-soft)", borderCollapse: "collapse" }}>
      <tbody>
        ...
        <tr>
          ...
          <td style={{ padding: "4px 0", fontFamily: "var(--font-mono)", fontSize: 11 }}>sebg</td>
        </tr>
      </tbody>
    </table>
  </div>
...
const STEAM_EN = `[h1]Bulgaria: Rhodope Highlands[/h1]
A [b]Slavic Enlarged[/b] kingdom sub-mod for Crusader Kings III.

A kingdom-level sub-mod expanding Bulgaria with unique highland cultures, events, and decisions tied to the Rhodope mountains and the Bulgarian tsardom's Slavic heritage.

[h1]Features[/h1]
[list]
[*] Tribal cultures of Bulgaria
[*] Royal decision: forge the Bulgarian culture
[*] Unique highland event chains
...
const STEAM_PL = `[h1]Bulgaria: Rhodope Highlands[/h1]
Sub-mod krolewskiego poziomu dla [b]Slavic Enlarged[/b] do Crusader Kings III.

Sub-mod rozszerzajacy Bulgarie o unikalne kultury gorskie, eventy i decyzje zwiazane z gorami Rodopami i slowianskim dziedzictwem carstwa bulgarskiego.

[h1]Zawartość[/h1]
[list]
[*] Kultury plemienne Bulgarii
[*] Decyzja krolewska: stworzenie kultury Bulgarskiej
...
const Overview: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 640 }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Bulgaria: Rhodope Highlands</CopyChip>
      <CopyChip kind="class">sebg</CopyChip>
    </div>
    <div style={{ fontFamily: "var(--font-body)", color: "var(--fg-on-dark)", lineHeight: 1.6 }}>
      <h2 style={{ fontFamily: "var(--font-display)", color: "var(--gold)", textShadow: "var(--shadow-carved)", margin: "0 0 12px" }}>
        Bulgaria: Rhodope Highlands
      </h2>
      <p>Sub-mod krolewskiego poziomu rozszerzajacy Bulgarie o unikalne kultury, eventy i decyzje zwiazane z wyzyna rodopska.</p>
      <ul style={{ paddingLeft: 20, marginTop: 12 }}>
        <li>Kultury plemienne Bulgarii</li>
        <li>Decyzja krolewska: stworzenie kultury Bulgarskiej</li>
...
const Screenshots: Story = () => (
  <ScreenshotGallery
    modName="Bulgaria: Rhodope Highlands"
    folder="sebg"
...
export default { title: "Marketing / Kingdoms / Bulgaria Rhodope Highlands" };
