...
/* ───── Moldavia: River Frontier — kingdom sub-mod ───── */
...
const frameStyle: React.CSSProperties = {
  ...
  backgroundImage: "url(/marketing/moldavia-kingdom-map.png)",
...
const KolovratGold: React.FC<{ size?: number }> = ({ size = 32 }) => (
  ...
  >
    <defs>
      <linearGradient id="kol-gold-semd" x1="0" y1="0" x2="1" y2="1">
...
const Cover: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "center" }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Moldavia: River Frontier</CopyChip>
      <CopyChip kind="token">512 &times; 512 HTML</CopyChip>
    </div>

    <div style={frameStyle} role="img" aria-label="Okladka moda Moldavia: River Frontier -- Kingdom sub-mod dla Slavic Enlarged">
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", zIndex: 1, gap: 0, filter: "drop-shadow(0 2px 8px #1c2214) drop-shadow(0 6px 20px #1c2214)" }}>
        ...
        <p style={titleLargeStyle}>Moldavia</p>
        <p style={titleSmallStyle}>River Frontier</p>
      </div>
    ...
    <table style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "var(--fg-on-dark-soft)", borderCollapse: "collapse" }}>
      <tbody>
        ...
        <tr>
          ...
          <td style={{ padding: "4px 0", fontFamily: "var(--font-mono)", fontSize: 11 }}>semd</td>
        </tr>
      </tbody>
    </table>
  </div>
...
const STEAM_EN = `[h1]Moldavia: River Frontier[/h1]
A [b]Slavic Enlarged[/b] kingdom sub-mod for Crusader Kings III.

A kingdom-level sub-mod expanding Moldavia with unique cultures, events, and decisions tied to the river frontier between the Slavic world and the steppe nomads.

[h1]Features[/h1]
[list]
[*] Tribal cultures of Moldavia
[*] Royal decision: forge the Moldavian culture
[*] Unique river frontier event chains
...
const STEAM_PL = `[h1]Moldavia: River Frontier[/h1]
Sub-mod krolewskiego poziomu dla [b]Slavic Enlarged[/b] do Crusader Kings III.

Sub-mod rozszerzajacy Moldawie o unikalne kultury, eventy i decyzje zwiazane z pograniczem rzecznym miedzy swiatem slowianskim a koczownikami stepowymi.

[h1]Zawartość[/h1]
[list]
[*] Kultury plemienne Moldawii
[*] Decyzja krolewska: stworzenie kultury Moldawskiej
[*] Unikalne eventy nadrzeczne
...
const Overview: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 640 }}>
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <CopyChip kind="component">Moldavia: River Frontier</CopyChip>
      <CopyChip kind="class">semd</CopyChip>
    </div>
    <div style={{ fontFamily: "var(--font-body)", color: "var(--fg-on-dark)", lineHeight: 1.6 }}>
      <h2 style={{ fontFamily: "var(--font-display)", color: "var(--gold)", textShadow: "var(--shadow-carved)", margin: "0 0 12px" }}>
        Moldavia: River Frontier
      </h2>
      <p>Sub-mod krolewskiego poziomu rozszerzajacy Moldawie o unikalne kultury, eventy i decyzje zwiazane z pograniczem rzecznym.</p>
      <ul style={{ paddingLeft: 20, marginTop: 12 }}>
        <li>Kultury plemienne Moldawii</li>
        <li>Decyzja krolewska: stworzenie kultury Moldawskiej</li>
        <li>Unikalne eventy nadrzeczne</li>
...
const Screenshots: Story = () => (
  <ScreenshotGallery
    modName="Moldavia: River Frontier"
    folder="semd"
...
export default { title: "Marketing / Kingdoms / Moldavia River Frontier" };
