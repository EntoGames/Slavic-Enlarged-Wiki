...
>
> - **Wydarzenia faz Walki** — `SSP/events/ssp_struggle_events.txt`
> - **Wydarzenia synkretyczne** — `SSP/events/ssp_syncretic_events.txt`
> - **Wydarzenia tradycji ludowych** — `SSP/events/ssp_tradition_events.txt`
> - **Wydarzenia główne SE** — `SE/events/wsl_main_events.txt`
>
...
| **ID** | `{{ssp_struggle.0010}}` |
| **Mod źródłowy** | {{SE / SSP}} |
| **Plik** | `{{SSP/events/ssp_struggle_events.txt}}` |
...
- {{+50 prestige}}
- {{+10 stress}}
- {{Wojownicy Peruna dostają -25% kosztu rekrutacji na 5 lat (modyfikator `{{wsl_event_modifier_perun_call}}`)}}
...
- `{{ssp_struggle.0011}}` — następstwo opcji A
- `{{ssp_struggle.0012}}` — następstwo opcji B
- {{...}}
